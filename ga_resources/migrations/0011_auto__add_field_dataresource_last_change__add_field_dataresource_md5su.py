...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataResource.last_change'
        db.add_column(u'ga_resources_dataresource', 'last_change',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataResource.md5sum'
        db.add_column(u'ga_resources_dataresource', 'md5sum',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataResource.last_change'
        db.delete_column(u'ga_resources_dataresource', 'last_change')

        # Deleting field 'DataResource.md5sum'
        db.delete_column(u'ga_resources_dataresource', 'md5sum')
