...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RelatedResource.left_index'
        db.add_column(u'ga_resources_relatedresource', 'left_index',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RelatedResource.right_index'
        db.add_column(u'ga_resources_relatedresource', 'right_index',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RelatedResource.how'
        db.add_column(u'ga_resources_relatedresource', 'how',
                      self.gf('django.db.models.fields.CharField')(default='left', max_length=8),
                      keep_default=False)


        # Changing field 'RelatedResource.foreign_key'
        db.alter_column(u'ga_resources_relatedresource', 'foreign_key', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'RelatedResource.local_key'
        db.alter_column(u'ga_resources_relatedresource', 'local_key', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):
        # Deleting field 'RelatedResource.left_index'
        db.delete_column(u'ga_resources_relatedresource', 'left_index')

        # Deleting field 'RelatedResource.right_index'
        db.delete_column(u'ga_resources_relatedresource', 'right_index')

        # Deleting field 'RelatedResource.how'
        db.delete_column(u'ga_resources_relatedresource', 'how')


        # User chose to not deal with backwards NULL issues for 'RelatedResource.foreign_key'
        raise RuntimeError("Cannot reverse this migration. 'RelatedResource.foreign_key' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'RelatedResource.local_key'
        raise RuntimeError("Cannot reverse this migration. 'RelatedResource.local_key' and its values cannot be restored.")
