...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataResource.big'
        db.add_column(u'ga_resources_dataresource', 'big',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataResource.big'
        db.delete_column(u'ga_resources_dataresource', 'big')
