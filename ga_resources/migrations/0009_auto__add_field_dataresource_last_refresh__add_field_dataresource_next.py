...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataResource.last_refresh'
        db.add_column(u'ga_resources_dataresource', 'last_refresh',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataResource.next_refresh'
        db.add_column(u'ga_resources_dataresource', 'next_refresh',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataResource.refresh_every'
        db.add_column(u'ga_resources_dataresource', 'refresh_every',
                      self.gf('timedelta.fields.TimedeltaField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataResource.last_refresh'
        db.delete_column(u'ga_resources_dataresource', 'last_refresh')

        # Deleting field 'DataResource.next_refresh'
        db.delete_column(u'ga_resources_dataresource', 'next_refresh')

        # Deleting field 'DataResource.refresh_every'
        db.delete_column(u'ga_resources_dataresource', 'refresh_every')
