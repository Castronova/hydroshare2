...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RenderedLayer.public'
        db.add_column(u'ga_resources_renderedlayer', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'RenderedLayer.owner'
        db.add_column(u'ga_resources_renderedlayer', 'owner',
        ...
        # Adding field 'Style.public'
        db.add_column(u'ga_resources_style', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Style.owner'
        db.add_column(u'ga_resources_style', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RenderedLayer.public'
        db.delete_column(u'ga_resources_renderedlayer', 'public')

        # Deleting field 'RenderedLayer.owner'
        db.delete_column(u'ga_resources_renderedlayer', 'owner_id')
        ...
        # Deleting field 'Style.public'
        db.delete_column(u'ga_resources_style', 'public')

        # Deleting field 'Style.owner'
        db.delete_column(u'ga_resources_style', 'owner_id')
