...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RenderedLayer.default_class'
        db.add_column(u'ga_resources_renderedlayer', 'default_class',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RenderedLayer.default_class'
        db.delete_column(u'ga_resources_renderedlayer', 'default_class')
