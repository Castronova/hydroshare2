...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataResource.resource_config'
        db.add_column(u'ga_resources_dataresource', 'resource_config',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataResource.resource_config'
        db.delete_column(u'ga_resources_dataresource', 'resource_config')
