...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DataResource.perform_caching'
        db.delete_column(u'ga_resources_dataresource', 'perform_caching')

        # Deleting field 'DataResource.method'
        db.delete_column(u'ga_resources_dataresource', 'method')

        # Deleting field 'DataResource.cache_ttl'
        db.delete_column(u'ga_resources_dataresource', 'cache_ttl')

        # Deleting field 'DataResource.data_cache'
        db.delete_column(u'ga_resources_dataresource', 'data_cache')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DataResource.perform_caching'
        db.add_column(u'ga_resources_dataresource', 'perform_caching',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DataResource.method'
        db.add_column(u'ga_resources_dataresource', 'method',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'DataResource.cache_ttl'
        db.add_column(u'ga_resources_dataresource', 'cache_ttl',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataResource.data_cache'
        db.add_column(u'ga_resources_dataresource', 'data_cache',
