...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Style.stylesheet_file'
        db.delete_column(u'ga_resources_style', 'stylesheet_file')

        # Adding field 'Style.stylesheet'
        db.add_column('ga_resources_style', 'stylesheet',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'Style.legend'
        db.alter_column('ga_resources_style', 'legend', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Style.stylesheet_file'
        raise RuntimeError("Cannot reverse this migration. 'Style.stylesheet_file' and its values cannot be restored.")
        # Deleting field 'Style.stylesheet'
        db.delete_column('ga_resources_style', 'stylesheet')


        # User chose to not deal with backwards NULL issues for 'Style.legend'
        raise RuntimeError("Cannot reverse this migration. 'Style.legend' and its values cannot be restored.")
