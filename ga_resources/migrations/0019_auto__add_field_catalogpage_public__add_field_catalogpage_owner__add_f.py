...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CatalogPage.public'
        db.add_column(u'ga_resources_catalogpage', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CatalogPage.owner'
        db.add_column(u'ga_resources_catalogpage', 'owner',
    ...
    def backwards(self, orm):
        # Deleting field 'CatalogPage.public'
        db.delete_column(u'ga_resources_catalogpage', 'public')

        # Deleting field 'CatalogPage.owner'
        db.delete_column(u'ga_resources_catalogpage', 'owner_id')
