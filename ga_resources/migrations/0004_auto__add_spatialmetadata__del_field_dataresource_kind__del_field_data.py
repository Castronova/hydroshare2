...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ga_resources_spatialmetadata', (
        ...
        db.send_create_signal('ga_resources', ['SpatialMetadata'])

        # Deleting field 'DataResource.kind'
        db.delete_column('ga_resources_dataresource', 'kind')
        ...
        db.delete_column('ga_resources_dataresource', 'bounding_box')

        # Adding field 'DataResource.spatial_metadata'
        db.add_column('ga_resources_dataresource', 'spatial_metadata',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ga_resources.SpatialMetadata'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SpatialMetadata'
        db.delete_table('ga_resources_spatialmetadata')

        # Adding field 'DataResource.kind'
        db.add_column('ga_resources_dataresource', 'kind',
                      self.gf('django.db.models.fields.CharField')(default='vector', max_length=24),
                      keep_default=False)
        ...
        db.add_column('ga_resources_dataresource', 'bounding_box',
        ...
        db.delete_column('ga_resources_dataresource', 'spatial_metadata_id')
    ...
    models = {
        ...
        'ga_resources.dataresource': {
            ...
            'spatial_metadata': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['ga_resources.SpatialMetadata']", 'unique': 'True', 'null': 'True'}),
